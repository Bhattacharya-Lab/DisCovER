...
################################################################################################################################
# this program generates hybrid 3-class input (rr) file from distance map histogram generated by trRosetta                     #
################################################################################################################################
...
for res_i in range(len(lines)):
	for res_j in range(len(lines[res_i])):
			...
			#print(lines[res_i][res_j])
                ...
                if (th > 8 and th <= 10): #2-9 bin for 6A
                        th = 7
                ...
                elif (th > 12 and th <= 14): #2-13 bin for 8A
                        th = 9

                elif (th > 14 and th <= 16): #14-17 bin for 8-10A
                        th = 10
                elif (th > 16 and th <= 18): #14-17 bin for 8-10A
                        th = 11

                elif (th > 18 and th <= 20): #18-21 for 10-12A
                        th = 12
                elif (th > 20 and th <= 22): #18-21 for 10-12A
                        th = 13
